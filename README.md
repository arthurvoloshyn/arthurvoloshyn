...
<table>
  ...
  <tr>
    <td>
      <img src="./assets/skills/frontend/react.png" alt="React" width="75" height="75" title="React"/>
    </td>
    <td>
      <img src="./assets/skills/frontend/mobx.png" alt="MobX" width="75" height="75" title="MobX"/>
    </td>
    <td>
      <img src="./assets/skills/frontend/graphql.png" alt="GraphQL and Apollo" width="75" height="75"
           title="GraphQL and Apollo"/>
    </td>
    <td>
      <img src="./assets/skills/frontend/next.png" alt="Next.js" width="75" height="75" title="Next.js"/>
    </td>
    <td>
      <img src="./assets/skills/frontend/react_native.png" alt="React Native" width="75" height="75"
           title="React Native"/>
    </td>
  </tr>
  <tr>
    <td>
      <img src="./assets/skills/frontend/vue.png" width="75" height="75"
           alt="Vue, as well as technologies such as Nuxt.js and Vuex"
           title="Vue, as well as technologies such as Nuxt.js and Vuex"
      />
    </td>
    <td>
      <img src="./assets/skills/frontend/rxjs.png" alt="RxJS" width="75" height="75" title="RxJS"/>
    </td>
    <td>
      <img src="./assets/skills/frontend/web_components.png" width="75" height="75"
    ...
    <td>
      <img src="./assets/skills/frontend/jquery.png" alt="jQuery" width="75" height="75" title="jQuery"/>
    </td>
    <td>
      <img src="./assets/skills/frontend/flow.png" alt="Flow" width="75" height="75" title="Flow"/>
    </td>
  </tr>
  <tr>
    <td>
      <img src="./assets/skills/frontend/pug.png" alt="Pug" width="75" height="75" title="Pug"/>
    </td>
    <td>
      <img src="./assets/skills/frontend/css_preprocessors.png" width="75" height="75"
           alt="CSS preprocessors such as SASS, LESS, Stylus and PostCSS"
           title="CSS preprocessors such as SASS, LESS, Stylus and PostCSS"
      />
    </td>
    <td>
      <img src="./assets/skills/frontend/css_frameworks.png" width="75" height="75"
    ...
    <td>
      <img src="./assets/skills/frontend/bundlers.png" width="75" height="75"
    ...
    <td>
      <img src="./assets/skills/frontend/js_testing_frameworks.png" width="75" height="75"
  ...
  <tr>
    <td>
      <img src="./assets/skills/frontend/pwa.png" alt="PWA and AMP" width="75" height="75" title="PWA and AMP"/>
    </td>
    <td>
      <img src="./assets/skills/other/git.png" width="75" height="75"
    ...
    <td>
      <img src="./assets/skills/other/docker.svg" alt="Docker" width="75" height="75" title="Docker"/>
    </td>
    <td>
      <img src="./assets/skills/other/linters.png" width="75" height="75"
    ...
    <td>
      <img src="./assets/skills/other/serverless_&_servers.png" width="75" height="75"
  ...
  <tr>
    <td>
      <img src="./assets/skills/other/cms.png" width="75" height="75"
           alt="CMS's such as Expression.Cloud and WordPress"
           title="CMS's such as Expression.Cloud and WordPress"/>
    </td>
    <td>
      <img src="./assets/skills/backand/nodejs.png" alt="Node.js" width="75" height="75" title="Node.js"/>
    </td>
    <td>
      <img src="./assets/skills/backand/php.png" alt="PHP" width="75" height="75" title="PHP"/>
    </td>
    <td>
      <img src="./assets/skills/backand/laravel.png" alt="Laravel" width="75" height="75" title="Laravel"/>
    </td>
    <td>
      <img src="./assets/skills/backand/databases.png" width="75" height="75"
